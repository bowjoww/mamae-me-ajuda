...
export async function generateCardsForTopic(req: {
  ...
  const userPrompt = [
    ...
    "",
    "PÚBLICO-ALVO (INVIOLÁVEL PARA TOM):",
    "- Estudante de ~12 anos, cursando 7º ano do Ensino Fundamental II no Brasil.",
    "- Linguagem cotidiana, frases curtas (máx 20 palavras).",
    "- EVITE: jargão universitário, termos em latim, 'plano cartesiano ortogonal de referência'.",
    "- PREFIRA: 'plano cartesiano', 'eixo x e eixo y', 'par (x, y)', 'par ordenado', 'quadrante'.",
    "- Exemplos do dia-a-dia ajudam: jogos, mapa, Minecraft, passos numa rua.",
    "- Trate o(a) estudante por você, tom de irmã mais velha/tutora, nunca 'senhora/senhor' nem 'aluno(a)'.",
    "- Um emoji só se couber natural (📍 🎯), nunca em rajada.",
    "",
    ...formatRules,
    "",
    "REGRAS GERAIS (INVIOLÁVEIS):",
    "- question é UMA pergunta clara. NUNCA entregue a resposta junto.",
    "- Se a question envolve fórmula ou matemática, explique a parte 'difícil' em parêntese com palavras simples — ex: 'abscissa (a primeira coordenada, x)'.",
    "- hint_chain é uma sequência ordenada de 2 a 4 dicas SOCRÁTICAS. Cada dica é UMA pergunta guiada ou pista que convida ao raciocínio — NÃO a resposta.",
    "- answer_explanation é o 'debrief' passo a passo. Começa do básico, usa exemplo concreto, só no fim apresenta o resultado. Fala com o estudante como se estivesse explicando pessoalmente.",
    "- difficulty: 'easy' (recordação direta), 'medium' (aplicação com 1-2 passos), 'hard' (combinar 2+ conceitos) — adequado ao 7º ano, não ao vestibular.",
  ].join("\n");
