...
export async function parseStudentIntent(req: RawIntentRequest): Promise<ParsedIntent> {
  ...
  const userPrompt = [
    ...
    "- Estudante de ~12 anos, 7º ano Ensino Fundamental II.",
    "- Títulos de subtópicos CURTOS (máx 8 palavras), em português simples, orientados ao que cai na prova.",
    "- Evite jargão universitário. Prefira 'eixos e coordenadas' a 'espaço vetorial R²'.",
    "- Não use numeração romana, nem ponto-e-vírgula em subtopic.title.",
    "",
    ...
    "- Cada etapa com estimated_minutes realista (15 a 60 minutos) para um(a) estudante do 7º ano.",
    "- Primeira etapa = revisão dos conceitos-base; última etapa = simulado/revisão geral.",
    "",
    "Fala do estudante:",
