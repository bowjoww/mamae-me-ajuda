...
const MARKDOWN_BASE_COMPONENTS = {
  ...
  code: ({ children }: { children?: React.ReactNode }) => (
    <code
      className="rounded px-1 py-0.5 font-hud text-xs"
      style={{
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="text-sm leading-relaxed prose prose-sm max-w-none prose-p:my-0 prose-ul:my-0 prose-ol:my-0"
        ...
        {!isUser && (
          <button
            ...
            className="mt-2 flex items-center gap-1.5 font-hud uppercase transition-colors disabled:opacity-50"
            style={{
